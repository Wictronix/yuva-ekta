        ...
        <main className="min-h-screen">
            ...
            <ProjectDetail
                ...
                description={[
                    ...
                    "The initiative is made possible through the generous and sustained support of Taj Gateway Resort, whose commitment to the community goes far beyond a single donation. This is an ongoing, daily operation for 365 days a year, no holidays."
                ]}
                stats={[
